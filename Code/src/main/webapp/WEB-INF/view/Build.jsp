...
<script>
    ...
    $("#addform").click(function(){
        //记录新建rule的数量
        var curr_size = document.getElementById("formpart").children.length+1;
...
'                                                            <div class="col-sm-10">\n' +
'                                                                <input type="text" class="form-control" id="value4'+curr_size +'" placeholder="null">\n' +
'                                                            </div>\n' +
'                                                        </div>\n' +
'                                                        <div class="form-group">\n' +
...
'                                                    </div>\n' +
'                                                </div>'
        document.getElementById("formpart").innerHTML+=addform;
        //删除表单
    ...
    function save(){
        ...
        var MustBePresent5=[];
        var MustBePresent6=[];
        var curr_size = document.getElementById("formpart").children.length+1;     //Rules数量
        ...
        console.log(MatchId5);
        console.log(MatchId6);
        ...
        console.log(AttributeId5);
        console.log(AttributeId6);
        console.log(MustBePresent4);
        console.log(MustBePresent5);
        console.log(MustBePresent6);
